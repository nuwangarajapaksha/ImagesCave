...
<html>
    <head>
        ...
        if (isset($_GET["id"])) {
            ...
            header("Location: ./adminPanel_Recent_ProductReport.php");
        }
        ?>
    </head>
    <body>
        ...
        if ($result->num_rows > 0) {
            ...
            <div class="sellerReprot-area">
                ...
                <a href="adminPanel_Recent_Products.php"><input type="button" value="Back" class="sellerReprot-area-button button-back"/></a>
