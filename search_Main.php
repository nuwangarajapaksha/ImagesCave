    ...
    <body>
        ...
        <div class="searchBar-area">
            <form method="get" action="search_Main.php" class="search-form">
                <span><input type="text" name="inSearch" id="inSearch" value="<?php echo $keyWord; ?>" class="searchBar" placeholder="search photos & illustrations"/>
                    <input type="submit" value="Search" class="searchButton"/></span>
            </form>
        </div>
