        ...
        if ($result->num_rows > 0) {
            ...
            <div class="productReport-area">
                ...
                <div class="productReport-details-aera">
                    ...
                    <form method="post" action="action/adminpanel_Product_Details_Updater.php">
                    ...
                    <a href="action/remove_Product.php?id=<?php echo $row["product_id"]; ?>"><input type="button" value="Remove" class="productReport-details-aera-button button-remove"/></a>
                    <a href="adminPanel_Products.php"><input type="button" value="Back" class="productReport-details-aera-button button-back"/></a>
