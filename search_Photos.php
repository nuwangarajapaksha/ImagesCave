...
<html>
    ...
    <body>
        ...
        <div class="searchBar-area">
            <form method="get" action="search_Photos.php" class="search-form">
                <input type="text" name="inSearch" id="inSearch" value="<?php echo $keyWord; ?>" class="searchBar" placeholder="search photos"/>
        ...
        <div class="search-area">
            ...
            <?php
            $query = "SELECT * FROM `product` WHERE `type_type_id` = (SELECT `type_id` FROM `type` WHERE `type_name` = 'photo' ) "
