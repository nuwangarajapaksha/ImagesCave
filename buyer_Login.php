...
<html>
    ...
    <body>
        ...
        <div class="bsLogin-area">
            ...
            <form method="post" action="action/check_Buyer_Login.php">

                <p class="bsLogin-area-content">Username</p>
                <input type="text" name="buyerEmailUsername" id="buyerEmailUsername" placeholder="email or username" class="bsLogin-area-input"/>
                ...
                <input type="password" name="buyerPassword" id="buyerPassword" placeholder="password" class="bsLogin-area-input"/>
            ...
            <p class="bsLogin-area-createNewAccount">Haven't existing account ? <a href="buyer_Registration.php">Create New Account</a></p>
