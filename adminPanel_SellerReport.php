...
<html>
    <head>
        ...
        if (isset($_GET["id"])) {
            ...
            header("Location: ./adminPanel_Sellers.php");
        }
        ?>
    </head>
    <body>
        ...
        if ($result->num_rows > 0) {
            ...
            <div class="sellerReprot-area">
                ...
                <a href="action/remove_Seller.php?id=<?php echo $row["seller_id"]; ?>"><input type="button" value="Remove" class="sellerReprot-area-button button-remove"/></a>
                <a href="adminPanel_Sellers.php"><input type="button" value="Back" class="sellerReprot-area-button button-back"/></a>
